...
export default function Page() {
  return (
    <Policy title="Returns & refunds" lede="Food safety comes first — but you should never be stuck with a bad pack.">
      ...
      <p>Send a photo of the item and its packaging to {SITE.phone} within <b>48 hours</b> of delivery, quoting your order reference. We will arrange a replacement or a full refund.</p>
